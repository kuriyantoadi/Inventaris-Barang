...
class Sarpras extends CI_Controller {
	...
	public function __construct()
	{
      ...
      // session login
		if ($this->session->userdata('waka_sarpras') != true) {
			$url = base_url('Login');
			redirect($url);
		}
	}
	...
	public function index()
	{
		...
		$this->load->view('template/header-sarpras');
	...
	public function barang()
	{
		...
		$this->load->view('template/header-sarpras');
		$this->load->view('sarpras/barang', $data);
		$this->load->view('template/footer-admin');
	}
	...
	public function barang_keluar()
	{
		...
		$this->load->view('template/header-sarpras');
		$this->load->view('sarpras/barang_keluar', $data);
		$this->load->view('template/footer-admin');
	}
	...
	public function barang_masuk()
	{
		...
		$this->load->view('template/header-sarpras');
		$this->load->view('sarpras/barang_masuk', $data);
		$this->load->view('template/footer-admin');
	}
