                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="<?= base_url() ?>Sarpras/index">
                                    <i class="ri-dashboard-line"></i> <span data-key="t-dashboard">Dashboard</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link menu-link" href="<?= base_url() ?>Sarpras/barang">
                                    <i class="ri-archive-line"></i> <span data-key="t-dashboard">Data Barang</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="<?= base_url() ?>Sarpras/barang_masuk">
                                    <i class="ri-login-box-line"></i> <span data-key="t-dashboard">Data Barang Masuk</span>
                                </a>
                            </li>

                             <li class="nav-item">
                                <a class="nav-link menu-link" href="<?= base_url() ?>Sarpras/barang_keluar">
